...
# 
@summary_routes.route('/mindmap_note_from_all_text', methods=['POST'])
...
# 
@summary_routes.route("/mindmap_note_from_all_audio_and_text", methods=["POST"])
...
# 
@summary_routes.route("/list_transcripts_from_audios", methods=["POST"])
